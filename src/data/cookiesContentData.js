// Default content for the Cookie Policy page. Used as fallback when nothing has
// been saved from the admin editor, and to fill in any newly added fields.
export const cookiesContentData = {
  hero: {
    title: 'Cookie Policy',
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio.'
    }
  ]
};
